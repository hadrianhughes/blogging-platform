...
export default class Menu extends React.Component
{
    ...
    componentDidMount()
    {
        $.get('/getBlogs', function(data)
        {
            ...
            blogs = data.map((blog) => <li key={blog.id}><a href="#" className="mobile-font-size" onClick={() => this.handleBlogClick(blog._id)}>{blog.name}</a></li>);
        ...
        return(
            <div id="blog-list-cont">
                ...
                <div className="footer">
                    <a href="#" className="float-left mobile-font-size" onClick={this.props.changeToLogin}>Make a blog</a>
                    <a href="#" className="float-right mobile-font-size">[BRAND NAME]</a>
                </div>
            </div>
        );
    }
